...
import com.example.taskmanagerapi.dto.CreateTaskDTO;
import com.example.taskmanagerapi.dto.TaskResponseDTO;
import com.example.taskmanagerapi.dto.UpdateTaskDTO;
...
public class TaskController {
    ...
    public ResponseEntity<Object> getAllTasks(@AuthenticationPrincipal User user) {
        ...
        List<Task> tasks = this.taskRepository.findByUserOrderByCreatedAtDesc(user);
