...
Java · Spring Boot · JWT · Redis · PostgreSQL · Docker · AWS SES
...
**3 - Configure AWS SES (email sending)**
...
To set up AWS SES from scratch:

1. Create an IAM user at https://console.aws.amazon.com/iam with policy `AmazonSESFullAccess`
...
```
POST > http://localhost:8080/workspaces/<workspace_id>/members
Authorization: Bearer <access_token>
```
...
```
POST > http://localhost:8080/boards/<board_id>/members
Authorization: Bearer <access_token>
```
